...
module.exports = function (grunt) {
    ...
    grunt.registerTask('docs', ['clean:docs', 'jsdoc:html', 'replace:docs', 'clean:out']);
    grunt.registerTask('tsdocs', ['clean:out', 'gitclone:plugins', 'jsdoc:json', 'buildtsdoc:phaser', 'replace:phasertsdefheader', 'clean:out']);
    ...
    grunt.registerTask('custom', 'Build a custom version of Phaser', function(arg) {
        ...
        if (!grunt.option('exclude'))
        {
            ...
            grunt.log.writeln("--split true (splits Phaser, p2 and Creature into separate files)");

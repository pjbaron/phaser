...
function BeamRootTimer()
{
	console.log("BeamRootTimer c'tor entry");
	...
	console.log("BeamRootTimer c'tor exit");
}


BeamRootTimer.prototype.start = function(_updateCallback, _updateContext)
{
	console.log("BeamRootTimer start");
...
BeamRootTimer.prototype.destroy = function()
{
	if (this.rafID)
 ...
 */
BeamRootTimer.prototype._updateRAF = function()
{
 ...
 */
BeamRootTimer.prototype._updateSetTimeout = function ()
{
	this._timer(this._getTime());
 ...
 */
BeamRootTimer.prototype._timer = function(_time)
{
	this.time = _time;
...
BeamRootTimer.prototype.getTime = function()
{

/**
 *
 * BeamWebGlTextures.js - texture handler for the BeamWebGl drawing functions
 * 
 */


function BeamWebGlTextures()
{
	this.onGPU = null;
	this.fb = null;
...
BeamWebGlTextures.prototype.create = function()
{
	this.onGPU = [];
	this.fb = null;
	this.currentSrcTexture = null;
...
BeamWebGlTextures.prototype.destroy = function()
{
	this.onGPU = null;
	this.fb = null;
	this.currentSrcTexture = null;
 ...
 *
 */
BeamWebGlTextures.prototype.prepareOnGPU = function(_texture, _tiling, _npot, _textureNumber)
{
 ...
 */
BeamWebGlTextures.prototype.prepare = function( _imageData, _tiling, _npot, _textureNumber, _flipy )
{
	// exit immediately if this _imageData is already the selected texture, unless it is marked dirty
	if (!_imageData || (!_imageData.isDirty && this.currentSrcTexture && this.currentSrcTexture.imageData === _imageData))
	{
		return false;
	}
	...
	else
	{
		...
		{
			console.log( "BeamWebGlTextures.prepare uploading source texture : ", _imageData.width, "x", _imageData.height );
		}
 ...
 *
 */
BeamWebGlTextures.prototype.prepareRenderToTexture = function( _width, _height )
{
	console.log( "BeamWebGlTextures.prepareRenderToTexture creating new target texture : ", _width, "x", _height );
 ...
 * 
 */
BeamWebGlTextures.prototype.setRenderTargetToTexture = function(_width, _height)
{
	if (!this.rttFb)
	{
	...
	console.log("BeamWebGlTextures.setRenderTargetToTexture", _width, "x", _height);
 ...
 *
 */
BeamWebGlTextures.prototype.stopRenderTexture = function()
{
...
BeamWebGlTextures.prototype.setRenderSourceImage = function( _textureNumber, _imageData )
{
	...
	{
		console.log("BeamWebGlTextures.setRenderSourceImage", _textureNumber, _imageData.width, "x", _imageData.height);
 ...
 *
 */
BeamWebGlTextures.prototype.prepareTextureForAccess = function(_texture)
{
	// if (_texture.canvas)
	// 	console.log("BeamWebGlTextures.prepareTextureForAccess", _texture.canvas.width, "x", _texture.canvas.height);
	// else if (_texture.imageData)
	// 	console.log("BeamWebGlTextures.prepareTextureForAccess", _texture.imageData.width, "x", _texture.imageData.height);
	// else
	// 	console.log("BeamWebGlTextures.prepareTextureForAccess", _texture.width, "x", _texture.height);
...
BeamWebGlTextures.prototype.getCanvasFromTexture = function(_ctx)
{
...
/**
 * getSurfaceFromTexture - grab the currentSrcTexture from the GPU into a BeamSurface
 * 
 */
BeamWebGlTextures.prototype.getSurfaceFromTexture = function(_surface)
{
	if (this.canReadTexture && this.fb)
	{
...
BeamWebGlTextures.prototype.getTextureData = function(_fb, _texture, _buffer)
{
...
BeamWebGlTextures.prototype.createTextureFromCanvas = function(_textureNumber, _canvas)
{
 ...
 */
BeamWebGlTextures.prototype.drawSurfaceToTexture = function(_surface, _textureWide, _textureHigh, _dstTextureRegister)
{
...
BeamWebGlTextures.initTexture = function(_textureRegister, _width, _height)
{
	var texture = gl.createTexture();
...
BeamWebGlTextures.initDepth = function(_texture)
{
...
BeamWebGlTextures.initFramebuffer = function(_texture, _depth)
{
...
BeamWebGlTextures.useFramebufferRenderbuffer = function( _texture )
{
	// create buffers
	var rttRenderbuffer = BeamWebGlTextures.initDepth( _texture );
	var rttFramebuffer = BeamWebGlTextures.initFramebuffer( _texture, rttRenderbuffer );

	// use buffers as the destination for the renderer drawing
	BeamPhaserRender.renderer.useFramebuffer = rttFramebuffer;
	BeamPhaserRender.renderer.useRenderbuffer = rttRenderbuffer;

	return rttFramebuffer;
};


BeamWebGlTextures.cancelFramebuffer = function()
{

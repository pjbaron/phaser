...
BeamTransformObject.prototype.create = function( _image, _x, _y, _z, _angleInRadians, _scaleX, _scaleY )
{
	...
	this.transform = Phaser.BeamMatrix3.makeTransform( this.x, this.y, this.angleInRadians, this.scale.x, this.scale.y );
	this.bounds = null;
};
...
BeamTransformObject.prototype.create3D = function( _image, _x, _y, _z, _rx, _ry, _rz, _scaleX, _scaleY, _scaleZ )
{
	...
	this.transform = Phaser.BeamMatrix4.makeTransform( _x, _y, _z, _rx, _ry, _rz, _scaleX, _scaleY, _scaleZ );
	this.bounds = null;
};
...
BeamTransformObject.prototype.update2D = function( _drawDictionary )
{
	...
	Phaser.BeamMatrix3.setTransform( this.transform, this.x, this.y, this.angleInRadians, this.scale.x, this.scale.y );

	// multiply with the transform matrix from my parent
	if ( this.parent && this.parent.transform )
	{
		Phaser.BeamMatrix3.setFastMultiply( this.transform, this.parent.transform );
	}
...
BeamTransformObject.prototype.update3D = function( _drawDictionary )
{
	...
	Phaser.BeamMatrix4.setTransform( this.transform, this.x, this.y, this.z, this.rx, this.ry, this.rz, this.scale.x, this.scale.y, this.scaleZ );
	// multiply with the transform matrix from my parent
	if ( this.parent && this.parent.transform )
	{
		...
		{
			Phaser.BeamMatrix4.setFastMultiply3( this.transform, this.parent.transform );
		}
		else
		{
			Phaser.BeamMatrix4.setFastMultiply( this.transform, this.parent.transform );
		}
	}
...
BeamTransformObject.prototype.calculateBounds = function()
{
	...
	if ( this.image )
	{
		...
		var p = [];
		p.push( Phaser.BeamMatrix3.transformPoint( lft, top, this.transform ) );
		p.push( Phaser.BeamMatrix3.transformPoint( rgt, top, this.transform ) );
		p.push( Phaser.BeamMatrix3.transformPoint( rgt, bot, this.transform ) );
		p.push( Phaser.BeamMatrix3.transformPoint( lft, bot, this.transform ) );

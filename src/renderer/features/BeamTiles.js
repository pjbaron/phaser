/**
 *
 * BeamTiles.js - handle tile drawing (rectilinear, grid-locked sprites) from a JSON tile map source
 * 
 */
...
BeamTiles.prototype.create = function(jsonName)
{
 ...
 */
BeamTiles.prototype.parseJSON = function(jsonName)
{

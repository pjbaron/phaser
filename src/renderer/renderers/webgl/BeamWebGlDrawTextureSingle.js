 ...
 *
 * Contains methods for BeamWebGl which draw a single sprite to the webGl display buffer, obtaining the data from a GPU texture
 *
 */
 ...
 *
 * @param  {Object} _texture - the gl.createTexture reference to the texture, must have width, height and register members (eg. if BeamWebGlTextures.initTexture created it)
 * @param  {BeamMatrix3} _transform - the transform to apply, can specify translation, rotation and scaling, plus anything else that goes into a 3x3 homogenous matrix
 * @param  {Number} _z - the z depth at which to draw
 */
BeamWebGl.prototype.drawTextureWithTransform = function( _texture, _transform, _z, _anchor )
{
...
BeamWebGl.prototype.drawTextureToDisplay = function( _texture, _shaderProgram)
{
...
BeamWebGl.prototype.applyShaderToTexture = function( _srcTexture, _callback, _context)
{

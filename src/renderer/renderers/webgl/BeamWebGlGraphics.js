 ...
 * pbWebGlGraphics
 *
 * Contains methods for BeamWebGl which support direct drawing to a GPU texture
 *
...
BeamWebGl.prototype.fillStyle = function(_fillColor, _lineColor)
{
...
BeamWebGl.prototype.fillRect = function( x, y, wide, high, color, targetWidth, targetHeight )
{
	// console.log( "BeamWebGl.fillRect" );
	if (color === undefined) color = this.fillColorRGBA;
	if (targetWidth === undefined) targetWidth = BeamPhaserRender.width;
	if (targetHeight === undefined) targetHeight = BeamPhaserRender.height;
...
// test for webgl drawing basics
BeamWebGl.prototype.drawRect = function( x, y, wide, high, color, targetWidth, targetHeight )
{
	// console.log( "BeamWebGl.drawRect" );
